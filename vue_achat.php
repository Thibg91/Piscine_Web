        ...
        <section>
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <button style="float:right" onclick="location.href='http://pool/vue_achat.php?filtre=filtre'" class="btn btn-info" type="button">Filtre</button>
                    <?php } if (isset($_GET['filtre'])){ ?>
                    ...
                    <button style="float:right" onclick="location.href='http://pool/vue_achat.php'" class="btn btn-secondary">Annuler</button>
                    <?php } ?>
                    <br>
                    <br>
                    <?php 
