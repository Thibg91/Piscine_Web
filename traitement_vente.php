...
if (($db)&&($go == 'lets go')) {  
    $sql = "INSERT INTO Items(enchere, meilleureO, AchatM, titre, descr, photo, prix, AchatImmediat, dateF, dateH, Categorie, emailAcheteur, emailVendeur) VALUES('$enchere', '$MeilleureO', '$AchatM', '$titre', '$descr','$photo', '$prix', '$immediat', '$dateF', '$dateH', '$cat','','$email')";    
