...
if (($db)&&($go == 'lets go')) {  
    $sql = "INSERT INTO Items(enchere, meilleureO, AchatM, titre, descr, photo, prix, AchatImmediat, dateF, dateH, Categorie, emailAcheteur, emailVendeur) VALUES('$enchere', '$MeilleureO', '$AchatM', '$titre', '$descr','$photos', '$prix', '0', '$dateF', '$dateH', '$cat','','$email')";    
