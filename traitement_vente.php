...
if (($db)&&($go == 'lets go')) {  
    $sql = "INSERT INTO Items(enchere, meilleureO, AchatM, titre, descr, photo, prix, ancienPrix, dateF, dateH, Categorie, emailAcheteur, emailVendeur) VALUES('$enchere', '$MeilleureO', '$AchatM', '$titre', '$descr','$photo', '$prix', '$prix', '$dateF', '$dateH', '$cat','','$email')";    
