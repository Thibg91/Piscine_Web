        ...
        <section>
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <button style="float:right" onclick="location.href='http://pool/vue_enchere.php?filtre=filtre'" type="button">Filtre</button>
                    <?php } if (isset($_GET['filtre'])){ ?>
                    ...
                    <button style="float:right" onclick="location.href='http://pool/vue_enchere.php'">Annuler</button>
                    <?php } ?>
                    <br>
                    <br>
                    <?php 
                    ...
                    if(isset($_POST['submit'])){
                        extract($_POST);
                            $sql = "SELECT * FROM items WHERE Categorie='$cat' AND enchere='oui'  ORDER BY dateF DESC";
                    }
                    else {
