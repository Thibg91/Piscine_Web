...
<body>
 ...
 <h1 id="logo" class="text-center" >        <img src="icone\logo.jpg" alt="Ebay ECE" />     </h1> 
 ...
 <li style="float:right"><a href="Compte.php"><svg class="bi bi-person-lines-fill" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
</svg> <FONT size="3"> Mon Compte </FONT> </a></li>
...
<li><a href="Vendre.php"><svg class="bi bi-credit-card" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
