...
<button type="button" class="btn btn-outline-info"><a href="Vendre.html"><svg class="bi bi-credit-card" width="6em" height="6em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
