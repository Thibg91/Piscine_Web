            ...
            <div class="row">
                ...
                <div class="col-8">
                   <button style="float:left" onclick="location.href='http://pool/Catégories.php'"class="btn btn-secondary" type="button">Retour aux Catégories</button>
                    ...
                    <button style="float:right" onclick="location.href='http://pool/musee.php?filtre=filtre'" class="btn btn-info" type="button">Filtre</button>
                    <?php } if (isset($_GET['filtre'])){ ?>
                    ...
                    <button style="float:right" onclick="location.href='http://pool/musee.php'" class="btn btn-secondary">Annuler</button>
                    <?php } ?>
                    <br>
                    <br>
                    <?php 
